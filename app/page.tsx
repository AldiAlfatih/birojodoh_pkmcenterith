...
const teamData = [
  ...
  },
  {
    ...
    minat: 'Kesehatan dan Gizi Masyarakat',
    butuh_anggota: 4,
    skill: ['Saya bisa menimbulkan ide ide apa saja yang di inginkan di dalam anggota kelompok untuk apa saja yang di laksanakan'],
    keahlian_dicari: ['Bisa merangkul dan bisa memahami apa yang di terapkan kepada ketua kelompok bisa cari solusi solusi'],
    wa: '6287781977395',
  },
  {
    id: 9,
    nama: "Nurfadillah Mu'min",
    nim: '251011071',
    ig: '@nufdhmn',
    prodi: 'Ilmu Komputer',
    angkatan: '2025',
    skema: 'PKM-K, PKM-PI, PKM-KI',
    status: 'Cari Tim',
    minat: 'Kemandirian Pangan, Energi, dan Air',
    butuh_anggota: 5,
    skill: ['Multimedia'],
    keahlian_dicari: ['Pengelolaan Keuangan dan Usaha', 'Web Development', 'Copywriting', 'Analisis Data'],
    wa: '6282269728578',
  },
];
